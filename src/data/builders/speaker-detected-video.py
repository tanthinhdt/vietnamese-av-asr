...
_REPO_PATH = "datasets/GSU24AI03-SU24AI21/speaker-detected-video"
_BRANCH = 'main'
    ...
    def _generate_examples(
        ...
        for i, sample in enumerate(dataset):
            video_path = os.path.join(
                data_dict[sample['channel']][0], sample['channel'], sample['chunk_video_id']
            )

            audio_path = os.path.join(
                data_dict[sample['channel']][1], sample['channel'], sample['chunk_audio_id']
            )
