...
class VietnameseAVASRConfig(datasets.BuilderConfig):
    """VietnameseAVASR configuration."""
...
class VietnameseAVASR(datasets.GeneratorBasedBuilder):
    """VietnameseAVASR dataset."""

    BUILDER_CONFIGS = [VietnameseAVASRConfig(name) for name in _CONFIGS]
