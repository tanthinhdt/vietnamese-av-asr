...
class Detector(Tasker):
    ...
    def _split_into_equally(self, crop_paths: list, ) -> List:
    ...
    def do(
        ...
        videoPath = metadata_dict['video_path']

        logger_.info('-'*44 + f"AS-detector processing" + '-'*44)
        self.outputPath = output_dir
        self.network_dir = os.path.join(tmp_dir, "network_results")
        ...
        if crop_paths:
            ...
            _paths = self._split_into_equally(crop_paths=crop_paths)
