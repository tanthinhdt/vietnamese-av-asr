    ...
    def detect(self, video_frames, detector):
        ...
        for frame in video_frames:
            ...
            for idx, detected_faces in enumerate(results.detections):
                ...
                ih, iw, ic = [_ for _ in frame.shape]
                ...
                lmx = [
                    ...
                    # [int(detected_faces.location_data.relative_keypoints[self.mp_face_detection.FaceKeyPoint(4).value].x * iw),
                    #  int(detected_faces.location_data.relative_keypoints[self.mp_face_detection.FaceKeyPoint(4).value].y * ih)],
                    # [int(detected_faces.location_data.relative_keypoints[self.mp_face_detection.FaceKeyPoint(5).value].x * iw),
                    #  int(detected_faces.location_data.relative_keypoints[self.mp_face_detection.FaceKeyPoint(5).value].y * ih)],
                    ]
